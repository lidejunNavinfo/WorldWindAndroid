...
public class SensorProgram extends ShaderProgram {
    ...
    protected void initProgram(DrawContext dc) {
        ...
        this.ovpMatrixId = GLES20.glGetUniformLocation(this.programId, "ovpMatrix");
        GLES20.glUniformMatrix4fv(this.ovpMatrixId, 2, false, this.array, 0);
    ...
    public void loadOccludeviewProjection(Matrix4 projection, Matrix4 occludeview) {
        projection.transposeToArray(this.array, 0);
        occludeview.transposeToArray(this.array, 16);
        GLES20.glUniformMatrix4fv(this.ovpMatrixId, 2, false, this.array, 0);
    }
